    ...
    <Section title="About Me" id="about">
      <div className="max-w-lg">
        ...
        <div className="mt-5 flex flex-col space-y-3 sm:flex-row sm:space-y-0 sm:space-x-4 justify-center lg:justify-start">
          <a className="flex items-center p-2 rounded-md bg-black text-white dark:bg-white dark:text-black" href="https://github.com/K3rnalP4n1c" target="_blank" rel="noreferrer noopener"><DiGithubBadge className="mr-1 text-2xl" />Github</a>
